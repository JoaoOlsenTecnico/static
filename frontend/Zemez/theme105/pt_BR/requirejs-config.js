...
var config = {
    map: {
        '*': {
            personalized: 'Milople_Personalizedcool/js/personalized',
					 	'Magento_Checkout/template/minicart/item/default.html':
            'Milople_Personalizedcool/template/minicart/item/default.html',
					  'Magento_Checkout/template/summary/item/details.html':
            'Milople_Personalizedcool/template/summary/item/details.html'
	    }
    }
};
require.config(config);
...
var config = {
    map: {
        "*": {
            ...
            "sticky": "TemplateMonster_PromoBanner/js/jquery.sticky"
        }
    },
    shim: {
        "dateFormat": ['jquery']
...
var config = {
    ...
    paths: {
        ...
        "tiltJs":           "Magento_Theme/js/tilt.jquery.min"
    },
    shim: {
        "owlcarousel":      ["jquery"],
