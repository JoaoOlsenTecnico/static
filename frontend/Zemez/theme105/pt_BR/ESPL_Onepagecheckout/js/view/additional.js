define(
    [
        ...
        'ESPL_Onepagecheckout/js/action/set-additional-information',
        'mage/calendar'
    ],
    function ($, ko, Component, quote, setAdditionalInformationAction, calendar) {
        ...
        var hsOscGiftwrap = ko.observable((quote.getTotals().espl_giftwrap_amount) ? true : false);
        var canShowSurveyOther = ko.observable(false);

        return Component.extend({
            defaults: {
                template: 'ESPL_Onepagecheckout/additional'
            },
