jQuery(document).ready(function($) {
    ...
    if($("#landing-menu").length) {
        $('#landing-menu.menu li a').click(function(evt) {
            ...
            $('#landing-menu.menu li a[href="#home"]').click(function(){
                $('html, body').stop().animate({
    ...
    (function() {
        ...
        function initHeader() {
            ...
            largeHeader = document.getElementById('landing-canvas-wrapper');
...
function onScroll(event){
    ...
    $('#landing-menu a').each(function () {
        ...
        if (refElement.position().top <= scrollPos && refElement.position().top + refElement.height() > scrollPos) {
            $('#landing-menu ul li').removeClass("active");
